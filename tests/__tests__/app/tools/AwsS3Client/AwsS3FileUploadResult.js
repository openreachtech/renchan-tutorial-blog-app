...
import AwsS3FileUploadResult from '../../../../../app/tools/aws/AwsS3FileUploadResult.js'

const payload = new AwsS3FileUploadPayload({
...
describe('AwsS3FileUploadResult', () => {
  test('normal', () => {
    const result = AwsS3FileUploadResult.create({
      payload,
      rawResult,
    })
